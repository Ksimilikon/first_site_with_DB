...
<body>
    <form action="changeUPDATE.php" method="get">
        <table border="1">
            <tr>
                <th>id_message</th>
                <th>id_user</th>
            ...
            <tr>
                <td><input name="id_message" value="<?=$row->id_message?>"></td>
                <td><input name="id_user" value="<?=$row->id_user?>"></td>
                ...
                <td><input name="dateANDtime" value="<?=$row->dateANDtime?>"></td>
            </tr>
        </table>
